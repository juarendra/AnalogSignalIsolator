...
| **SENSOR SIDE** | `5V` | Catu keluar terisolasi untuk sensor | VCC sensor 5 V |
...
6. Pilih satu mode keluaran, kemudian nyalakan catu +5 V host.

## Pemilih mode pada PCB ini

![Area pemilih mode pada PCB](assets/pcb-top-view.jpg)

PCB pada foto menggunakan tiga footprint jumper solder/0 Ω bertuliskan `M2.4V1`, `M3.3V1`, dan `M5V1` dengan instruksi **FIT ONE ONLY**.

- Pasang/jumper **satu saja** dari ketiga pilihan tersebut.
- `M2.4V1` ditujukan untuk ADC dengan batas rendah, misalnya ESP32.
